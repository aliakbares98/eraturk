...
@Component({
  selector: 'era-individual-party-edit',
  templateUrl: './individual-party-edit.component.html',
  styleUrls: ['./individual-party-edit.component.scss']
})
export class IndividualPartyEditComponent extends EditDialogComponent<IndividualPartyDTO> implements OnInit, OnDestroy {

  constructor(public partyService: PartyService,
    public dialogRef: MatDialogRef<IndividualPartyEditComponent>,
  ...
  save(): void {
    this.loading = true;
    const subResult = this.partyService.updateIndividualParty(this.prepareModel()).subscribe((result: CommandResponseDTO) => {
